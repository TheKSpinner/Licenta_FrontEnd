import classes from './AllMedicsLogged.module.css'
import MedicsList from './MedicsListLogged';
    ...
    return (
        <section>
            ...
            {Object.keys(groupedMedics).map((location) => (
                <div key={location}>
                    <h2 className={`${classes.title} ${classes.locationCard}`}>{location}</h2>
...
export default AllMedicsLogged;
